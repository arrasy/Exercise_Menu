...
public class luasPersegiP extends AppCompatActivity {
    ...
    private void hitung() {
        ...
        double yaitu = panjang * lebar;
        hasil.setText("Luas Persegi Panjang dengan panjang: "+ panjang + " dan Lebar: " + lebar +" adalah " +yaitu);
    }
}
